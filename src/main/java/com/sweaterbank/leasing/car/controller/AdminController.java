...
public class AdminController {
    ...
    public AdminController(LeaseService leasingService, CalculationService calculationService, MailSenderService mailService)
    {
    ...
    public ResponseEntity<CalculationResponse> calculate(@Valid @RequestBody ApplicationIdRequest requestData) {
